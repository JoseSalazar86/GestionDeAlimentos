...
public class ExistenciasControllers {
    ...
    @GetMapping("/fifo/{alimentoId}")
    public ResponseEntity<List<Existencias>> obtenerExistenciasFIFO(@PathVariable Long alimentoId) {
        List<Existencias> existencias = existenciasServices.obtenerExistenciasPorAlimentoOrdenadas(alimentoId);
